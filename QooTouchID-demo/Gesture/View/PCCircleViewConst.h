 ...
 *  普通状态下外空心圆颜色
 */
#define CircleStateNormalOutsideColor [UIColor grayColor]

/**
 *  选中状态下外空心圆颜色
 */
#define CircleStateSelectedOutsideColor [UIColor orangeColor]
 ...
 *  选中状态下内实心圆颜色
 */
#define CircleStateSelectedInsideColor [UIColor orangeColor]
 ...
 *  选中状态下三角形颜色
 */
#define CircleStateSelectedTrangleColor [UIColor orangeColor]
 ...
 *  普通时连线颜色
 */
#define CircleConnectLineNormalColor [UIColor orangeColor]
